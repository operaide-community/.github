<p align="center">
  <img src="operaide-logo.svg" alt="Operaide" width="96">
</p>
...
<p align="center">
  <a href="https://operaide.ai/community-edition"><strong>Apply for one of the 100 spots</strong></a><br>
  <sub>Email and GitHub handle · under a minute · free</sub>
</p>

<!-- The application link above is a placeholder until the registration page is live. -->

![Operaide Studio with the Operaide Code agent](framework.png)
...
![Operaide Platform: the diagram of a multi-agent application](platform.png)
...
1. **Apply.** Your email and GitHub handle are all we need. It takes under a minute. By September 30, 2026.
